...
<div class="container">
    ...
    <div class="row" style="margin-top: 5vh;margin-bottom: 5vh;">
        <div class="col">
            <h1 class="text-center" style="color: #9b1519;"><strong>Casa - 1</strong></h1>
        </div>
    </div>
    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2">
        <div class="col">
            <div class="row row-cols-1">
                <div class="col d-flex flex-row justify-content-center align-items-center align-items-xl-center"><i class="icon ion-ios-home" style="font-size: 36px;margin-left: 3%;"></i>
                    <h3 style="margin: 0px;margin-left: 15px;">Bairro Blau</h3>
                </div>
                ...
                <div class="col d-flex flex-row justify-content-center align-items-center justify-content-xl-center align-items-xl-center" style="height: 54px;"><i class="la la-money" style="font-size: 36px;margin-left: 3%;color: rgb(58,204,160);"></i>
                    <h2 style="margin: 0px;margin-left: 15px;color: #18c38f;"><strong>R$ 250.000</strong></h2>
                </div>
            </div>
        </div>
        <div class="col">
