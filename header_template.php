...
<body>
    ...
    <div>
        ...
        <div class="row" style="height: 66px;background-color: #9b1519;">
            ...
            <div class="col" style="height: 66px;display: flex;align-items: center;justify-content: flex-end;">
                <a  id="search" href="#" style="margin: 0px 20px;">
    ...
    <div id="searchbar" class="row" style="background-color: #9b1519; display: none;">
        <div class="col-xl-2 d-flex justify-content-center align-items-center"><select style="width: 100%;height: 30px; margin-left:12%"><option value="12" selected>Localização</option><option value="13">This is item 2</option><option value="14">This is item 3</option></select></div>
        ...
        <div class="col d-flext justify-content-end align-items-center"><button class="btn border rounded shadow" type="button" style="background-color: #ffffff;width: 50%;margin-top: 5%;margin-bottom: 5%;margin-left:80px;">Pesquisar</button></div>
    </div>
